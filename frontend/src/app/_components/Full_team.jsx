...
const Full_team = () => {
  return (
    <div>
        <div><Event_lead/></div>
        <div className='lg:-mt-20'><Core_council/></div>
        <div className='lg:-mt-20'><Chairperson/></div>
        <div className='lg:-mt-20'><Vice_chair/></div>
        <div className='lg:-mt-32'><Sec/></div>
        <div className='lg:-mt-20'><Dept_lead/></div>
