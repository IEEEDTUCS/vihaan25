...
const About = () => {
  ...
  return (
    <div className="relative mb-0 flex items-center justify-between w-full max-[750px]:mt-20 sm:mt-20 pr-0 overflow-hidden ">
      ...
      <motion.div className="z-10 w-[250%] m-6 text-wrap sm:mx-10 md:mx-14 lg:mx-20 max-[1280px]:relative max-[1280px]:w-full ">
        <motion.div
        ...
        >
          <img
            ...
            alt="Heading"
            className="w-full max-[750px]:relative max-[750px]:left-0 max-[750px]:w-[60%] max-[750px]:top-[40%]"
          />
        </motion.div>
        <motion.h1
          whileInView={{ x: 0, opacity: 1 }}
        ...
        <motion.p
          ...
          transition={{ duration: 1 }}
          viewport={{ once: true }}
          className="text-para pr-[0] mt-4 text-justify xl:w-[100%] w-full font-orbitron font-normal tracking-wider max-[600px]:text-[50%] text-[#A59188] sm:tracking-widest max-[600px]:pr-[20%] max-[600px]:w-full text-base "
        >
          ...
          using technology. Students participate in teams of up to 4 members
          across various tracks. To add to the experience and learning quotient,
          teams that make it past the hackathon are awarded various cash prizes
          and goodies.
        </motion.p>
        <motion.div
          whileInView={{ x: 0, opacity: 1 }}
