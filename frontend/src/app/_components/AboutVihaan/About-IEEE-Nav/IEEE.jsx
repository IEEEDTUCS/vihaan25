      ...
      >
        <div className=" w-full bg-local flex flex-col items-center justify-start">
          ...
          <div className="flex flex-col items-center h-[13rem] justify-center p-[10%] bg-[url(/Images-Abt-IEEE/Abt-IEEE/box.svg)] bg-contain bg-no-repeat bg-center w-full text-ellipsis">
            <ul><p className="font-orbitron text-5xl flex flex-row w-full justify-center relative -top-[25%] text-[#A59188]">
              2000+
            </p>
            ...
            <div className="flex flex-col items-start w-full justify-items-center mt-[5%]">
              <ul>
                <li className="flex items-center gap-4">
                  <IoLocation />
                  <a className="font-orbitron text-base font-medium tracking-wide text-[#A59188]">Delhi Technological University</a>
                </li>
