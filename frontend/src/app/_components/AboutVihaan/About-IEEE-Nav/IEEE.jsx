        ...
        <div className="bg-local w-full flex flex-col items-center justify-start">
          ...
          <div className="flex flex-row justify-around w-full mt-[5%]">
            ...
            <div className="flex flex-col items-start relative -top-[4%]">
              ...
              <p className="font-orbitron text-base font-medium tracking-wide text-[#A59188] my-[2%]">
                Abhimanyu Kumar Jha
                <br />
                <hr /> (+91 93104 48583) <hr />
              </p>
              <p className="font-orbitron text-base font-medium tracking-wide text-[#A59188] mb-[2%]">
                Spruha Kar
                <br />
