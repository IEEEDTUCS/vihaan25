...
return (
        ...
        <div className={`${className}  bg-[url(/Images-Abt-IEEE/Abt-IEEE/Bg.svg)] bg-cover h-[100vh] w-[25%] max-[768px]:w-[65%] max-[668px]:w-[77%] max-[450px]:w-[95%] max-[1280px]:w-[35%] max-[1024px]:w-[45%] max-[400px]:w-[105%] max-[1500px]:w-[30%] fixed -right-150 duration-300 ease-in flex flex-col items-center justify-start p-[3%] max-[1024px]:p-[4%]  max-[700px]:p-[8%] max-[768px]:p-[8%] max-[500px]:p-[9.5%] z-[9999] top-0`}>
          <div className="overflow-hidden bg-cover w-full flex flex-col items-center justify-start ">
                ...
                <div className="flex flex-row justify-around w-full mt-[5%] ">
                        ...
                        <div className="flex flex-col items-start relative -top-[4%]">
                                ...
                                <p className="font-orbitron text-base font-medium tracking-wide text-[#A59188] my-[2%]">Abhimanyu Kumar Jha<br /> <br /> (+91 93104 48583) <br /></p>
                                <p className="font-orbitron text-base font-medium tracking-wide text-[#A59188] mb-[2%]">Spruha Kar <br /><br />(+91 72178 61438) <br /></p>
