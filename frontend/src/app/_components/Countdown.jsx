   ...
   return (
      <div>
        ...
        `}
         ...
         <div className="relative -top-50 grid grid-flow-col gap-5 justify-center text-center md:scale-100 scale-50 min-[500px]:scale-75  mx-5  sm:scale-90 auto-cols-max">
