...
const Countdown = ({ targetTime }) => {
  ...
  return (
    <div>
      ...
      <div className="relative grid grid-flow-col -mt-30 md:mt-0 gap-5 justify-center text-center md:scale-100 scale-50 min-[500px]:scale-75  mx-5  sm:scale-90 auto-cols-max">
        ...
        <div className="flex flex-col countdown-box font-normal h-[132px] w-[108px] font-['Orbitron'] items-center justify-center">
          <span className="countdown font-mono text-5xl">
            <span
              style={{
                "--value": Math.floor((timeLeft % 86400) / 3600).toString(),
