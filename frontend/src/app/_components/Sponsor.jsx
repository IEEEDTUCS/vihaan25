...
const Sponsor = () => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-start overflow-hidden lg:mx-20 md:mx-16 sm:mx-8 mx-4 max-sm:-top-10 font-orbitron">
      ...
      transition={{duration:1}}
      viewport={{ once: true }}
      className="text-4xl text-center mb-4">Sponsors</motion.p>
      <motion.div 
      whileInView={{x:0, opacity:1}}
      initial={{opacity:0, x:-100}}
      transition={{duration:1}}
      ...
      transition={{duration:1}}
      viewport={{ once: true }}
      className="text-4xl text-center mb-4">Technology Partners</motion.p>
      <motion.div 
      whileInView={{x:0, opacity:1}}
      initial={{opacity:0, x:-100}}
      transition={{duration:1}}
      ...
      transition={{duration:1}}
      viewport={{ once: true }}
      className="text-4xl text-center mb-4">Community Partners</motion.p>
      <motion.div 
      whileInView={{x:0, opacity:1}}
      initial={{opacity:0, x:-100}}
      transition={{duration:1}}
      ...
      transition={{duration:1}}
      viewport={{ once: true }}
      className="text-4xl text-center mb-4">Course Partners</motion.p>
      <motion.div 
      whileInView={{x:0, opacity:1}}
      initial={{opacity:0, x:-100}}
      transition={{duration:1}}
