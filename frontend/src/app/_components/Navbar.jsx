...
const Navbar = () => {
  ...
  return (
    <nav className="relative bg-transparent text-white">
          ...
          <div className=" md:block hidden xl:absolute xl:right-8 ">
            <div className=" flex items-baseline lg:relative xl:relative md:absolute md:top-6 lg:top-0 md:right-8 lg:right-0  xl:left-0.5   relative " >
              ...
              <div className="flex justify-evenly space-x-0 md:space-x-4 border-white  ">
                ...
                <div className='hidden md:block' style={{ textAlign: 'center', justifyContent: 'center', display: 'flex', flexDirection: 'column', color: '#8F7E77', fontSize: 12, fontFamily: 'Orbitron', fontWeight: '400', letterSpacing: 2.40, wordWrap: 'break-word' }}>TEAM</div>
                <div className='hidden md:block' style={{ textAlign: 'center', justifyContent: 'center', display: 'flex', flexDirection: 'column', color: '#8F7E77', fontSize: 12, fontFamily: 'Orbitron', fontWeight: '400', letterSpacing: 2.40, wordWrap: 'break-word' }}>JUDGES</div>

                <div className='hidden md:block' style={{ textAlign: 'center', justifyContent: 'center', display: 'flex', flexDirection: 'column', color: '#8F7E77', fontSize: 12, fontFamily: 'Orbitron', fontWeight: '400', letterSpacing: 2.40, wordWrap: 'break-word' }}>FAQ</div>
                <div className='hidden md:block' style={{ textAlign: 'center', justifyContent: 'center', display: 'flex', flexDirection: 'column', color: '#8F7E77', fontSize: 12, fontFamily: 'Orbitron', fontWeight: '400', letterSpacing: 2.40, wordWrap: 'break-word' }}>TRACK</div>
                <div className='hidden md:block' style={{ textAlign: 'center', justifyContent: 'center', display: 'flex', flexDirection: 'column', color: '#8F7E77', fontSize: 12, fontFamily: 'Orbitron', fontWeight: '400', letterSpacing: 2.40, wordWrap: 'break-word' }}>TRACK</div>
          ...
          <div className="-mr-2 flex md:hidden">
            ...
            >
              <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="8.65106" y="8.28872" width="22.6979" height="22.6979" stroke="#A59188" strokeWidth="0.867306" />
                <rect x="20.0828" y="10.0394" width="13.6332" height="13.6332" transform="rotate(45 20.0828 10.0394)" stroke="#A59188" strokeWidth="0.867306" />
                <rect x="20.0828" y="2.8862" width="23.7493" height="23.7493" transform="rotate(45 20.0828 2.8862)" stroke="#A59188" strokeWidth="0.867306" />
                <line x1="20.0866" x2="20.0866" y2="5.49854" stroke="#A59188" strokeWidth="0.173461" />
                <line x1="20.0866" y1="33.7768" x2="20.0866" y2="39.2753" stroke="#A59188" strokeWidth="0.173461" />
                <line x1="39.6375" y1="19.7244" x2="34.139" y2="19.7244" stroke="#A59188" strokeWidth="0.173461" />
                <line x1="5.86087" y1="19.7244" x2="0.362328" y2="19.7244" stroke="#A59188" strokeWidth="0.173461" />
      ...
      {/* Mobile Menu */}
      {isOpen && <GridLayout className="md:hidden  lg:hidden " style={{ zIndex: 1000 }} />}
    </nav>
  );
};
