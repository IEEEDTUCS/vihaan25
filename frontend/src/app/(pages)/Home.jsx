    ...
    <>
      <div className="relative flex min-h-screen flex-col items-center justify-start overflow-y-scroll">
        ...
        <Image src={Logo} alt="Vihaan Logo" width={100} height={100} className="absolute top-8"/>
          ...
          <Image src={Clockwise} alt="FixedAroundClock" className='absolute animate-clockwise'/>
          ...
          <Image src={VerticleLines} alt="Verticle Lines" className="absolute top-[50] z-10 Verticle Lines" />
        ...
        <div className="relative flex items-center justify-center top-6 lg:top-12 w-full">
          ...
          {/* Clock Hand - Centered */}
          <Image src={MovingHand} alt="MovingHand" className="relative  lg:h-full opacity-30 top-4 right-2 origin-top animate-clockHand"/>
        </div>
        </div>
        <div className="text-content font-extrabold relative flex items-center flex-col jusitfy-center top-60 lg:top-90 z-10">
              <h1 className="text-6xl lg:text-[9rem] font-khinterference ">VIHAAN 8.0</h1>
              <h2 className="text-white text-3xl font-khinterference relative">AWAITS YOU</h2>
              <h2 className="text-white mt-40 lg:mt-0 font-pprightGrotesk text-[10px]">REGISTER AT</h2>
              <div className="apply-button" data-hackathon-slug="vihaan8" data-button-theme="dark-inverted"
 ></div>
              <Image src={HorizontalVectors} alt="Horizontal Lines" className="relative top-20 z-10 Verticle Lines" />

              <h4 className='mt-15 text-2xl font-light font-khinterference text-bold tracking-wider' >WELCOME CODER</h4>
              <h5 className='w-56 mt-2 font-light font-khinterference text-center'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sint hic vero debitis.</h5>
        </div>
      </div>
    </>
  )
